...
<template>
  <div id="hot" style="padding: 30px 40px 0 40px">
    ...
    <div class="swiper swiper-bili">
      <SwiperCard :dataSource="list.bili" />
    </div>
      ...
      >
        <swiper-slide v-for="(o, index) in list.kugou" class="swiper-kugou">
          <el-card :body-style="{ padding: '0px' }">
            ...
            <div
              style="
                background-color: rgba(84, 73, 73, 0.27);
                transform: translate(0, -22px);
              "
            >
              <span style="font-size: 12px; color: #ffffff">{{ o.view }}</span>
              <span
                style="font-size: 12px; color: #ffffff; margin-left: 15px"
                >{{ o.reply }}</span
              >
              <span
                style="font-size: 12px; color: #ffffff; margin-left: 15px"
            ...
            <div
              style="height: 18px; width: 253px; transform: translate(0, -20px)"
            >
              <span
                style="
                  font-size: 12px;
    ...
    <div class="platform" style="font-size: 18px; color: #272727">
      网易云音乐
    </div>
    <div class="swiper swiper-cloud">
      ...
      >
        <swiper-slide
          v-for="(o, index) in list.netease"
          class="swiper-cloud-slide"
        >
          <el-card :body-style="{ padding: '0px' }">
