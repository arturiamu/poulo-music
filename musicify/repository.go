...
type MusicRepository interface {
	...
	RemoveMusic(ctx context.Context, id uint) (*models.Music, error)
	ModifyMusic(ctx context.Context, music *models.Music) (*models.Music, error)
	GetMusicByID(ctx context.Context, id uint) (*models.Music, error)
	...
	ListMusicByPlaylistID(ctx context.Context, playlistId uint) ([]*models.Music, error)

	SavePlaylist(ctx context.Context, playList *models.Playlist) (*models.Playlist, error)
	RemovePlaylist(ctx context.Context, id uint) (*models.Playlist, error)
	...
	RemovePlaylistItem(ctx context.Context, id uint) (*models.PlaylistItem, error)
}
